...
const Cards = (props) => {
  return (
    <div className="card text-gray-300 w-[clamp(160px,80%,280px)] hover:brightness-90 transition-all cursor-pointer group bg-gradient-to-tl from-gray-900 to-gray-950 hover:from-gray-800 hover:to-gray-950 border-r-4 border-t-2 border-gray-900 rounded-md overflow-hidden relative">
      <div className="p-1 flex justify-evenly">
        ...
        <div>
          <div className="uppercase font-bold text-sm">{props.name}</div>
